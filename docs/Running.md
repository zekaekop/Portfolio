<h1>Running the Porfolio project</h1>
...
```git
git clone (Your Fork Url) # Ex: https://github.com/zekaekop/Portfolio.git
```
...
<h1>The current project does not include fixtures/sample database</h1>
